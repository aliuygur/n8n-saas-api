              ...
              <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-lg p-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-300">
                          <span className="font-semibold text-green-400">3 days free trial</span>
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-300">
                          Then <span className="font-semibold text-white">$9.99/month</span> after trial
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-indigo-500/20">
                  <p className="text-sm text-gray-400">
                    Cancel anytime. Your trial starts when you deploy your first instance.
                  </p>
                </div>
              </div>
            </div>
