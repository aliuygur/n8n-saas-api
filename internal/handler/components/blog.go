...
func GetAllBlogPosts() []BlogPost {
	posts := []BlogPost{
		...
		},
		{
			...
			Description: "Discover why ranx.cloud is the easiest way to deploy and manage n8n instances on Google Cloud Platform with automatic SSL and updates.",
			Author:      "ranx.cloud Team",
			AuthorBio:   "Helping teams deploy and manage n8n workflow automation on Google Cloud Platform.",
			AuthorImage: "https://ui-avatars.com/api/?name=ranx.cloud&background=6366f1&color=fff&size=128",
			Date:        time.Date(2024, 12, 15, 0, 0, 0, 0, time.UTC),
			ReadTime:    "4 min read",
			Keywords:    []string{"ranx.cloud", "n8n hosting", "managed n8n", "n8n gcp"},
			OGImage:     "https://ranx.cloud/static/android-chrome-512x512.png",
