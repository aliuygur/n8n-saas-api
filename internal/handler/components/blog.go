	...
	posts := []BlogPost{
		{
			...
			Author:      "ranx.cloud Team",
			AuthorBio:   "Helping teams deploy and manage n8n workflow automation.",
			AuthorImage: "https://ui-avatars.com/api/?name=ranx.cloud&background=6366f1&color=fff&size=128",
		...
		{
			Slug:        "why-choose-ranx-cloud-for-n8n",
			Title:       "Why Choose ranx.cloud for Your n8n Hosting?",
			Description: "Discover why ranx.cloud is the easiest way to deploy and manage n8n instances with automatic SSL and updates.",
			Author:      "ranx.cloud Team",
			AuthorBio:   "Helping teams deploy and manage n8n workflow automation.",
			AuthorImage: "https://ui-avatars.com/api/?name=ranx.cloud&background=6366f1&color=fff&size=128",
			Date:        time.Date(2024, 12, 15, 0, 0, 0, 0, time.UTC),
			ReadTime:    "4 min read",
			Keywords:    []string{"ranx.cloud", "n8n hosting", "managed n8n"},
			OGImage:     "https://ranx.cloud/static/android-chrome-512x512.png",
